# WorkCycle Context
Generated: 2026-01-02 00:10:30
Run ID: 1251 | Project: Workflow Hub | Task: T008
...
## Current Task: T008
**Title**: Add drag-and-drop file upload to task detail page
**Status**: in_progress
**Pipeline Stage**: DEV
**Priority**: 5

### Description
The task detail page only has a standard file input button for uploads. The drag-and-drop functionality exists in task-modal.js (initDropzone function) but is not used on the task detail page.

Expected: Drag and drop files onto attachments area with visual feedback.
Current: Only file picker button works.
Solution: Reuse initDropzone() from task-modal.js and add dropzone container.
